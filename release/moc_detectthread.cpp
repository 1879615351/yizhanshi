...
#include <memory>
#include "../untitled/detectthread.h"
...
QT_MOC_LITERAL(1, 13, 13), // "sendTestLabel"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 1), // "n"
QT_MOC_LITERAL(4, 30, 4), // "mark"
QT_MOC_LITERAL(5, 35, 16), // "setProjectFolder"
QT_MOC_LITERAL(6, 52, 4) // "path"

    },
    "detectThread\0sendTestLabel\0\0n\0mark\0"
    "setProjectFolder\0path"
};
...
void detectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendTestLabel((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->setProjectFolder((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (detectThread::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&detectThread::sendTestLabel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void detectThread::sendTestLabel(int _t1, QString _t2)
{
